...
{
	class WebGUIImage : PictureBox, IGuiElement, IGuiProperty
	{
		String curPicture;
		Int32 stretch;
		...
		{
			// TODO: Implement PictureVal
			String picture = curPicture;
			if (String.IsNullOrEmpty(picture))
				this.Image = null;
			else
			{
				this.Image = new ImageResourceHandle(picture);
			}
		}
		// TODO: PictureVal can be an object (IPicture)
		String curPictureVal;
		public string GuiPictureVal
		{
			get { return this.curPictureVal; }
			set
			{
				this.curPictureVal = value;
				ShowPicture();
			}
		}
		...
		#region IGuiImage Members

		public int GuiStretch
		{
			get
			{
				return stretch;
