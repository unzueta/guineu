...
namespace Guineu.Functions
{
    class FGETS : ExpressionBase
    {
        ...
        internal override string GetString(CallingContext context)
        {
            ...
            int nBytes = bytesExpression == null ? 8192 : bytesExpression.GetInt(context);

            string retVal = string.Empty;
            if (retVal == null) throw new NotImplementedException();

            LowLevelFileMngr llfmngr = GuineuInstance.FFilesManager;
            retVal = llfmngr.Fgets(guineuHandle, nBytes);
