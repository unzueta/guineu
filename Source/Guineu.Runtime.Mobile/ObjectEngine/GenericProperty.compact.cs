...
namespace Guineu.ObjectEngine
{
	public class GenericProperty : PropertyMember
	{
		...
		public GenericProperty(KnownNti name, Variant value)
		{
			initialValue = value;
			Nti = name;
			control = null;
			supportedType = VariantType.Unknown;
		}

		public GenericProperty(KnownNti name, Variant value, IControl owner)
		{
			initialValue = value;
			Nti = name;
			control = owner;
		...
		public GenericProperty(KnownNti name, Variant value, IControl owner, VariantType isType)
		{
			initialValue = value;
			Nti = name;
			control = owner;
