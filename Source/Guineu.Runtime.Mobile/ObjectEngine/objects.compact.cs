...
namespace Guineu.ObjectEngine
{
	public sealed partial class ObjectFactory
	{
		partial void RegisterBaseClasses()
		{
			...
			classes.RegisterBaseClass(new basGridTemplate("GRID"));
			classes.RegisterBaseClass(new basColumnTemplate("COLUMN"));
			classes.RegisterBaseClass(new basHeaderTemplate("HEADER"));
		}
	}
}