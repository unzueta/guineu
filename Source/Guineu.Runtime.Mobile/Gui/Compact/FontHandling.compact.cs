...
namespace Guineu.Gui.Compact
{
	...
	static class FontHandling
	{
		...
		public static void Set(Control ctrl, KnownNti nti, Variant value)
		{
			switch (nti)
			{
				...
				case KnownNti.FontName:
					ctrl.Font = new Font(value, ctrl.Font.Size, ctrl.Font.Style);
					break;

				case KnownNti.FontSize:
					ctrl.Font = new Font(ctrl.Font.Name, value, ctrl.Font.Style);
					break;
		...
		public static Variant Get(Control ctrl, KnownNti nti)
		{
			...
			{
				case KnownNti.FontBold:
					return new Variant(Enum<FontStyle>.IsSet(ctrl.Font.Style, FontStyle.Bold));

				case KnownNti.FontItalic:
					return new Variant(Enum<FontStyle>.IsSet(ctrl.Font.Style, FontStyle.Italic));
				...
				case KnownNti.FontStrikeThru:
					return new Variant(Enum<FontStyle>.IsSet(ctrl.Font.Style, FontStyle.Strikeout));

				case KnownNti.FontUnderline:
					return new Variant(Enum<FontStyle>.IsSet(ctrl.Font.Style, FontStyle.Underline));
		...
		private static void SetFontStyle(FontStyle style, Control ctrl, bool setStyle)
		{
			...
			if (setStyle)
				...
				newStyle = ctrl.Font.Style & ~style;
			ctrl.Font = new Font(ctrl.Font.Name, ctrl.Font.Size, newStyle);
		}
	}
}
